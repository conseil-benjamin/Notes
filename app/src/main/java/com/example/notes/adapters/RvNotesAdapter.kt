...
import com.example.notes.databinding.NoteItemLayoutBinding
import com.example.notes.fragments.NoteFragmentsDirections
        ...
        getItem(position).let { note ->
            holder.apply {
                ...
                itemView.setOnClickListener{
                    ...
                    val action=NoteFragmentsDirections.actionNoteFragmentsToSaveOrUpdate()
                        .setNote(note)
