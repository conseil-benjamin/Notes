...
class SaveOrUpdate : Fragment(R.layout.fragment_save_or_update) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        contentBinding.fabColorPick.setOnClickListener {
            ...
            val bottomSheeView: View = layoutInflater.inflate(
            ...
            {
                setContentView(bottomSheeView)
                show()
            }


            val bottomSheetBinding = BottomSheetLayoutBinding.bind(bottomSheeView)
        ...
        if (contentBinding.etNoteContent.text.toString().isEmpty() ||
            ...
            when (note) {
                null -> {
                    ...
                    navController.navigate(SaveOrUpdateDirections.actionSaveOrUpdateToNoteFragments())
    ...
    private fun updateNote() {
        if (note!=null)
        {
            noteActivityViewModel.uptadeNote(
                Note(
                    note!!.id,
                    contentBinding.etTitle.text.toString(),
                    contentBinding.etNoteContent.getMD(),
